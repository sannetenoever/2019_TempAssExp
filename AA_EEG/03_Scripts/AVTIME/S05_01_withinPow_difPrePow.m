        ...
        for asna = 1:2
            for resp = 1:2
                ...
                for trc = 1:length(trl)
                    in = find(ismember(FF.trialinfo(:,11)-FF.trialinfo(trl(trc),11),(1:pr)*-1) & FF.trialinfo(:,9) >= 0);
                    if length(in) >= 1
...
%end
save(['D:\Experiments\StartTimeExp\AA_EEG\04_MidData\AVTIME\SaveD\S05_01_PowAccInterStat'],'st');

%% plot the whole shebang
load(['D:\Experiments\StartTimeExp\AA_EEG\04_MidData\AVTIME\SaveD\S05_01_PowAccInterStat'],'st');
...
exportfig(gcf, ['D:\Experiments\StartTimeExp\AA_EEG\05_Figures\AVTIME\S05_01_PowAccInterTopo'], 'Color', 'rgb');
print(['D:\Experiments\StartTimeExp\AA_EEG\05_Figures\AVTIME\S05_01_PowAccInterTopo'],'-dpng');
...
set(gcf, 'position',[500 500 375 270]);
exportfig(gcf, ['D:\Experiments\StartTimeExp\AA_EEG\05_Figures\AVTIME\S05_01_PowAccInter'], 'Color', 'rgb');
print(['D:\Experiments\StartTimeExp\AA_EEG\05_Figures\AVTIME\S05_01_PowAccInter'],'-dpng');
